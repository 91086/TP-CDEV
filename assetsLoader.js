...
export async function loadAssets(escena) {
    ...
    try {
        ...
        const [salaGltf, cajaGltf, tableroGltf, luzEmergenciaGltf, cascoGltf] = await Promise.all([
        ...
        return { salaGltf, cajaGltf, tableroGltf, luzEmergenciaGltf, cascoGltf, sala, cajaHerramientas, tablero, luzEmergencia, casco};
